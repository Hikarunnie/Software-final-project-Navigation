...
class RoadMap:
  ...
  def _load_hardcoded(self):
    ...
    self.edges = {
      "1-3-a": {"from": 1, "to": 3, "length": 13, "direction": "left",
                "reverse_direction": "right"},
      "1-2-a": {"from": 1, "to": 2, "length": 7, "direction": "forward",
                "reverse_direction": "right"},
      "1-3-b": {"from": 1, "to": 3, "length": 5, "direction": "left",
                "reverse_direction": "right"},
      "2-3-a": {"from": 2, "to": 3, "length": 2, "direction": "forward",
                "reverse_direction": "forward"},
      "2-3-b": {"from": 2, "to": 3, "length": 10, "direction": "forward",
                "reverse_direction": "forward"},
    }
  ...
  def all_neighbors_shortest(self, node_id):
    ...
    return [(neighbor, length, edge_id) for neighbor, (length, edge_id) in
            seen.items()]
